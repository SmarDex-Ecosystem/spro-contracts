...
contract DeployArbitrum is DeploySpro {
    address constant SDEX = 0xabD587f2607542723b17f14d00d99b987C29b074;
    ...
    function run() external returns (Spro spro_, SproLoan sproLoan_) {
        require(block.chainid == ARBITRUM_CHAIN_ID, "SproArbitrum script: Must be deployed on Arbitrum network");
