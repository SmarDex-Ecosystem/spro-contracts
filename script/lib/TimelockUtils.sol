...
library TimelockUtils {
    ...
    function scheduleAndExecute(TimelockController timelock, GnosisSafeLike safe, address target, bytes memory payload)
        internal
    {
    ...
    function scheduleAndExecuteBatch(TimelockController timelock, address[] memory targets, bytes[] memory payloads)
        internal
    {
