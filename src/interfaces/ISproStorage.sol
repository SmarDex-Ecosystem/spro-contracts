...
interface ISproStorage {
    ...
    /**
     * @notice Retrieves the address of the collateral recipient associated with the given proposalNonce-borrower hash.
     * @param nonceBorrowerHash The hash combining the proposalNonce and the borrower's address.
